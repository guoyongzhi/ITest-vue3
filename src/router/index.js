...
import itesteRouter from './modules/iTest'
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '更多',
        meta: { title: '更多', icon: 'more', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'CreateArticle',
        meta: { title: '创建条目', icon: 'edit' }
      },
      {
        path: 'edit/:id(\\d+)',
        component: () => import('@/views/example/edit'),
        name: 'EditArticle',
        meta: { title: '编辑条目', noCache: true, activeMenu: '/example/list' },
        hidden: true
      },
      {
        path: 'list',
